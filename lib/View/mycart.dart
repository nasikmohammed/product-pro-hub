...
import 'package:miniproject_1/View/proceedtopay.dart';


class ScreenMyCart extends StatefulWidget {
  ScreenMyCart({super.key});

  @override
  State<ScreenMyCart> createState() => _ScreenMyCartState();
}

class _ScreenMyCartState extends State<ScreenMyCart> {
  int _counter = 0;
  void _increment() {
    _counter++;
  }
